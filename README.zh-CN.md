...
Taurus Stack 只有**一个全功能版本**，以 AGPLv3 开源：工作流引擎、审批流、安全扫描、程序管理、扩展中心等全部功能模块默认开放，不存在社区版 / 企业版的功能裁剪。版本之间仅通过**主机配额**与 **License 服务等级**区分：

| 模式 | 可托管主机 | 用户 / 任务 / 工作流 / 脚本版本 / 并发 | 白标定制 | 服务支持 |
| --- | --- | --- | --- | --- |
| 免费版（无 License） | 50 台 | 均不限制 | 不支持 | 社区互助，无商业 SLA |
| 商业 License（starter / professional / enterprise / ultimate） | 按等级提升 | 均不限制 | 专业版及以上支持 | 分级商业支持（工单 / 专属渠道 / SLA） |
